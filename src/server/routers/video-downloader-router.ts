  ...
  downloadVideo: privateProcedure
    ...
    .post(async ({ c, ctx, input }) => {
      ...
      try {
        ...
        // AUTO-POST: This will be handled by a background job queue in the future
        // For now, the frontend handles posting after download completes
        console.log('[VideoDownloader] Video ready for posting. Frontend will handle posting.')
